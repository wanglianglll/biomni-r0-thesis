...
OUT = ROOT / "data/sft_targeted_100k_v1"
SEED = 20260428

SPECS = [
    ("D1", ROOT / "data/sft_d1_datalake_v2/d1_datalake_train.jsonl", 50000),
    ("D2", ROOT / "data/sft_d2_contrast_v1/d2_contrast_train.jsonl", 5000),
    ("D3", ROOT / "data/sft_d3_verifiable_v1/d3_verifiable_sft_train.jsonl", 5000),
    ("D4", ROOT / "data/sft_d4_rare_disease_v1/d4_rare_disease_train.jsonl", 5000),
    ("D5", ROOT / "data/sft_d5_gwas_variant_v1/d5_gwas_variant_train.jsonl", 15000),
    ("D6", ROOT / "data/sft_d6_gwas_causal_gene_v1/d6_gwas_causal_gene_train.jsonl", 20000),
]
...
def normalize_schema(obj: dict, mixture_part: str) -> dict:
    return {
        ...
        "mixture_dataset": "sft_targeted_100k_v1",
...
def main() -> None:
    ...
    all_rows = []
    summary = {
        "dataset": "sft_targeted_100k_v1",
        "seed": args.seed,
        "policy": "D1-heavy mixture with targeted D4/D5/D6 repairs. Assistant messages are single FINAL ANSWER lines.",
        "parts": {},
    }
    global_seen = set()
    ...
    (args.out / "README.md").write_text(
        "# SFT Targeted 100K V1\n\n"
        "A short-validation SFT mixture that keeps D1 broad coverage while adding D4/D5/D6 targeted repairs.\n\n"
        "- D1: 50K direct datalake samples\n"
        "- D2: 5K contrast samples\n"
        "- D3: 5K verifiable samples\n"
        "- D4: 5K rare-disease targeted samples\n"
        "- D5: 15K GWAS variant-prioritization targeted samples\n"
        "- D6: 20K GWAS causal-gene targeted samples\n",
        encoding="utf-8",
    )
